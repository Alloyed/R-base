...
public class Settings {
	...
	@ControlElement (x=400,y=70, 
			properties = {"label=width", "width=30","listen=true"})
	public String WINDOW_WIDTH = "800";
	@ControlElement (x=440,y=70, 
			properties = {"label=height", "width=30","listen=true"})
	public String WINDOW_HEIGHT = "600";
	public boolean USE_OPENGL = false;
	
	@ControlElement (x=400,y=110, 
			properties = {"label=skin", "width=70","listen=true"})
